package ar.edu.um.programacion2.card.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("CreditCard");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("CreditCard");
        ...
        config.getMapConfigs().put("ar.edu.um.programacion2.card.domain.*", initializeDomainMapConfig(jHipsterProperties));
